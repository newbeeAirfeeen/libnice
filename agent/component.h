...
void nice_component_close(NiceAgent *agent, NiceStream *stream,
                          NiceComponent *component);

void nice_component_shutdown(NiceComponent *component, gboolean shutdown_read,
...
void nice_component_restart(NiceComponent *component, NiceAgent *agent);

void nice_component_update_selected_pair(NiceAgent *agent, NiceComponent *component,
...
void nice_component_attach_socket(NiceComponent *component, NiceSocket *nsocket);

void nice_component_remove_socket(NiceAgent *agent, NiceComponent *component,
                                  NiceSocket *nsocket);
...
void nice_component_clean_turn_servers(NiceAgent *agent, NiceComponent *component);
...
void nice_component_add_valid_candidate(NiceAgent *agent, NiceComponent *component,
...
guint nice_component_compute_rfc4571_headroom(NiceComponent *component);
